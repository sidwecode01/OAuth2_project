<script setup>
import { useAuthentification } from '@/stores/oauth2';
import { onMounted, ref } from 'vue';
import router from '@/router';
// import { RouterLink } from 'vue-router';
const store = useAuthentification();
      ...
      >
        ...
        >
          ...
          <form @submit.prevent="register" class="space-y-4">
            ...
            <div>
              <label for="name" class="mb-2  dark:text-gray-400 text-lg">Name</label>
              <input
                id="name"
                v-model="name"
            ...
            <div>
              <label for="confirm_password" class="mb-2 dark:text-gray-400 text-lg">Password confirmation</label>
              <input
                id="confirm_password"
